...
var elementCounter = jQuery("input[name=element-max-id]").val();
    ...
    jQuery(document).ready(function() {  
        jQuery("#add-featured-post").click(function() {  
            ...
            var inputFormId = jQuery("input[name=form_id]", elementRow);
            inputFormId.attr("name", "wppl_shortcode["+ elementCounter +"][form_id]");
            ...
            var inputAddressTitle = jQuery("input[name=address_title]", elementRow);
            inputAddressTitle.attr("name", "wppl_shortcode["+ elementCounter +"][address_title]"); 
            ...
            inputMapWidth.attr("name", "wppl_shortcode["+ elementCounter +"][map_width]");
             ...
             var inputAutoZoom = jQuery("input[name=auto_zoom]", elementRow);
            inputAutoZoom.attr("name", "wppl_shortcode["+ elementCounter +"][auto_zoom]");
            
            var inputZoomLevel = jQuery("select[name=zoom_level]", elementRow);
            inputZoomLevel.attr("name", "wppl_shortcode["+ elementCounter +"][zoom_level]");
            ...
            var inputDisplayRadius = jQuery("input[name=display_radius]", elementRow);
            inputDisplayRadius.attr("name", "wppl_shortcode["+ elementCounter +"][display_radius]");
            
            var inputDistanceValues = jQuery("input[name=distance_values]", elementRow);
            inputDistanceValues.attr("name", "wppl_shortcode["+ elementCounter +"][distance_values]");
            
            var inputDisplayUnits = jQuery("input[name=display_units]", elementRow);
            inputDisplayUnits.attr("name", "wppl_shortcode["+ elementCounter +"][display_units]");
            
            var inputUnitsName = jQuery("select[name=units_name]", elementRow);
            inputUnitsName.attr("name", "wppl_shortcode["+ elementCounter +"][units_name]");
            ...
            var inputResultsType = jQuery("input[name=results_type]", elementRow);
            inputResultsType.attr("name", "wppl_shortcode["+ elementCounter +"][results_type]");
            ...
            var inputWordsExcerpt = jQuery("input[name=words_excerpt]", elementRow);
            inputWordsExcerpt.attr("name", "wppl_shortcode["+ elementCounter +"][words_excerpt]");
