...
* When the address entered does not exist the information will not be saved and the user will be asked to enter the address again. This is a great feature to guarantee that the address entered is verified.
...
* show/hide excerpt.
* different styling to choose from.
