...
= 2.4.6.4 =
* Fix: Bug causes multiple geocode calls when submitting a form which results in over query limit 

= 2.4.6.3 =
* Fix: issue with address fields when saving a post type in the backend

= 2.4.6.2 =
*Fix: Warning cause by non-existing taxonomies when creating a form which "Pages" only selected as post types.

= 2.4.6.1 =
*Fix: Cannot activate plugin due to conflict with Premium Add-ons
