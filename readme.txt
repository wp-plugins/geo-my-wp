...
1. For demonstration please vistin http://www.geomywp.com

== Changelog ==

== 1.6.1 ==

* bug fix - buddypress search brings no results - wp_users query result with empty array
* bug fix - Widget for BP member's location will not display map.
* Bug fix - User's current location widget - address form did not work.
