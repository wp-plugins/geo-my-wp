...
Using Google's API tools GEO my WP provides an advance proximity search for any post type or buddypress's members based on a given address within a given radius.
...
to see the post type part in action go <a href="http://www.geomywp.com/search-estates/" target="_blank">here</a> and enter 33063 in the address field
to see the Buddypress part in action go <a href="http://www.geomywp.com/search-members/" target="_blank">here</a> and enter 33063 in the address field
