				...
				<div class="wppl-address-wrapper">        		
					...
					<div class="wppl-address-field-wrapper">
						...
						<?php if( isset($locator_icon['show']) && $locator_icon['show'] == 1 ) { ?>
							<button type="button" value="<?php echo $params['form']; ?>" onClick="getLocation();formId=this.value;" class="wppl-locate-me-btn"><img src="<?php echo plugins_url('images/locator-images/'.$locator_icon['icon'], __FILE__); ?>" /></button>
						<?php } ?>
					</div>
				</div><!-- end address wrapper -->
...
function wppl_location_shortcode($locate) {
	...
	$location .= 						'<span><a href="#" onClick="showSpinner();getLocationNoSubmit();" ><div id="wppl-locator-message">Get your current Location</a></div></span>';
	$location .=					'</div>';
