...
add_shortcode( 'wppl_single_location' , 'wppl_shortcode_single' );
...
function wppl_location_shortcode($locate) {
	...
	$location .=		'<span class="wppl-your-location-location"><a href="#" id="location-form-btn">' . $_COOKIE['wppl_' . $display_by]; if($display_by == 'city' && $_COOKIE['wppl_state']) { $location .= ' ,' . $_COOKIE['wppl_state'];} $location .='</a></span>';
