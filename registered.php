...
function wppl_location_shortcode($locate) {
	...
	$location .=			'<form class="wppl-location-form" name="wppl_location_form" action="" method="post">';
	$location .=				'<div>';
	$location .=					'<input type="text" name="wppl_user_address" class="wppl-user-address" value="" placeholder="zipcode or full address..." />';
	$location .= 					'<button type="button"  onClick="getLocationNoSubmit();" class="wppl-locate-me-btn"><img src="' . plugins_url('images/locator-images/'.$options['locator_icon'], __FILE__) . '"></button>';
	$location .=				'</div>';
	$location .=				'<input type="button" onclick="retAddress=wppl_user_address.value;getUserLocation();" value="go" />';
