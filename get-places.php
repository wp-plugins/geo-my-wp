...
function get_results_within( $org_address, $radius ) {
	...
	global $posts_within, $map_data, $plugin_map, $total_rows, $by_driving, $mikm_n, $posts_within, $map_type;
	...
	echo 				'<script type="text/javascript">'; echo 'locations= '.json_encode($posts_within),';'; echo 'your_location= '.json_encode($your_loc),';'; echo 'page= '.json_encode($from_page),';'; echo 'mapType= '.json_encode($map_type),';'; echo  '</script>';
