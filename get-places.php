...
function wppl_shortcode($params) {	
	...
	echo 	'<form class="wppl-'; if($params[form_only] == 1) { echo "widget-";}; echo 'form" name="wppl_form" id="wppl-form" action="'; if($params[form_only] == 1) { echo "/" . $options['results_page'];} echo '" method="get">';
