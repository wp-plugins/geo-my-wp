<table class="widefat fixed">
			...
			<tr>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[near_location_on] " type="checkbox" value="1" disabled="disabled"/><span class="wppl-premium-message"></span></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[featured_posts_on] " type="checkbox" value="1" disabled="disabled" /> <span class="wppl-premium-message"></span></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[map_icons_on] " type="checkbox" value="1" disabled="disabled" /><span class="wppl-premium-message"></span></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[posts_scroller_on] " type="checkbox" value="1" disabled="disabled" /><span style="color:brown"> Under development </span></p>
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[restaurant_on] " type="checkbox" value="1" disabled="disabled" /> <span class="wppl-premium-message"></span></p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<p style="color:brown; font-size:12px;"><input name="wppl_plugins[estate_on] " type="checkbox" value="1" disabled="disabled"/><span class="wppl-premium-message"></span></p>
				</td>
			</tr>
			<tr>
				<td>
