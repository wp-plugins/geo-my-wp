...
jQuery(document).ready(function() {  
	...
	jQuery("table tr td span.wppl-premium-message").html('Premium version only! <a href="http://wpplugins.com/plugin/1227/geo-my-wp-premium/" target="_blank">Get your copy now</a>'); 
