	...
	<h2><?php echo _e('GEO my WP - Shortcodes','wppl'); ?></h2>
		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td>
					<p class="wppl-write-shortcode"> [wppl_single_location] </p>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<p class="wppl-write-shortcode"> &#60;?php echo do_shortcode(&#39;[wppl_single_location]&#39;); ?&#62;</p>
				</td>
				</tr>
				<tr>
				<td>
		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td>
					<p class="wppl-write-shortcode"> &#60;?php echo do_shortcode(&#39;[wppl_current_location]&#39;); ?&#62;</p>
				</td>
				</tr>
				<tr>
				<td>
