							...
							<td>
								<div class="wppl-settings">
									...
									<span class="help-btn-tooltip-wrapper">
										<a href="#" class="wppl-help-btn"><img src="<?php echo plugins_url('/geo-my-wp/images/help-btn.png'); ?>" width="25px" height="25px"  /></a>
										<span class="wppl-help-message">
											<?php _e('Enter you country code. For example for United States enter US. you can find your country code <a href="http://www.wpplaceslocator.com/wp-content/country-code.php" target="blank">here</a>', 'GMW'); ?>
											<span class="help-arrow"></span>
										</span>
									</span>
								</div>
							...
							<select name="wppl_fields[results_page]">
								<?php 
									...
									foreach ($pages_s as $page_s) {
										echo '<option value="'.$page_s->post_name.'"'; echo ( isset($wppl_options['results_page']) && $wppl_options['results_page'] == $page_s->post_name ) ? 'selected="selected"' : "" ; echo '>'. $page_s->post_title . '</option>';
									}
								?>
							</select>
