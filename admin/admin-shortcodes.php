            	...
            	<tr>
            		<th>
			    		...
			    		<span style="padding: 4px 5px;border-radius: 3px;border: 1px solid #CCC;background:#fafafa;"><a title="Create new post types shortcode" href="admin.php?page=wppl-shortcodes&gmw_action=new&gmw_form_type=friends&gmw_form_id=<?php echo $next_id; ?>"><?php _e('Buddypress Members','GMW'); ?></a></span>  
			    			<?php } ?>
			    			<?php if ( isset( $wppl_on['groups'] ) && $wppl_on['groups'] == 1 ) { ?>
			    		<span style="padding: 4px 5px;border-radius: 3px;border: 1px solid #CCC;background:#fafafa;"><a title="Create new post types shortcode" href="admin.php?page=wppl-shortcodes&gmw_action=new&gmw_form_type=groups&gmw_form_id=<?php echo $next_id; ?>"><?php _e('Buddypress Groups','GMW'); ?></a></span>  
			    			<?php } ?>
	           		...
	           		<?php foreach ($options_r as $key => $option) : ?>
						...
						<tr>
		                    ...
		                    <td>
								...
								<?php } elseif ($option['form_type'] == 'groups') { ?>
									<span>BP Groups search form</span>
								<?php }?>
