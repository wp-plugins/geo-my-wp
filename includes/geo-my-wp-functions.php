...
abstract class GMW {
     ...
     *
     * This is a must be function when extending the class
     * this function loads the search form
     *
     */
    ...
    public function gmw() {
        ...
        if ( $this->form['results_page_use'] == false && isset( $this->form['search_form'] ) ) {
        ...
        // when form submitted
        if ( apply_filters( 'gmw_form_submitted_trigger', false, $this ) == true || ( $this->form['submitted'] == true && ( ( $this->form['results_page_use'] == true ) || ( $this->form['results_page_use'] == false && $this->form['ID'] == $_GET['gmw_form'] && $this->form['search_results']['results_page'] == false ) ) ) ) {

            self::form_submitted();

        // if auto results 
        } elseif ( $this->form['search_results']['results_page'] == false && $this->form['ul_lat'] != false && $this->form['ul_lng'] != false && isset( $this->form['search_results']['auto_search']['on'] ) ) {
...
function gmw_get_search_form_address_field( $gmw, $id, $class ) {
	...
	$id		   	   	= ( isset( $id ) && $id != '' ) ? $id : 'gmw-address-field-wrapper-'.$gmw['ID'];
