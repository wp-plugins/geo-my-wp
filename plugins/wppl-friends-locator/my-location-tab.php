 			...
 			<div id="edit-user-location">
				...
				<div class="metabox-tabs-div">
					...
					<div class="address-tab" id="address-tab-wrapper">	
 						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('street', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
							<label for="street">Street:</label>
							<input name="wppl_street" id="wppl_street" type="text" value="<?php echo $member_loc_tab[0]['street']; ?>" />
						</div>
						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('apt', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
							<label for="apt">Apt/Suit:</label>
							<input name="wppl_apt" id="wppl_apt" type="text" value="<?php echo $member_loc_tab[0]['apt']; ?>"/>
 						</div>
 				
 						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('city', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
							<label for="city">City:</label>
							<input name="wppl_city" id="wppl_city" type="text" value="<?php echo $member_loc_tab[0]['city']; ?>" />
 						</div>
 						
 						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('state', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
 						...
 						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('zipcode', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
							<label for="zipcode">Zipcode:</label>
							<input name="wppl_zipcode" id="wppl_zipcode" type="text" value="<?php echo $member_loc_tab[0]['zipcode']; ?>" />
						</div>
				
						<div class="single-input-fields" <?php if (isset($wppl_options['friends']['location_tab_address_fields']) && !in_array('country', $wppl_options['friends']['location_tab_address_fields'])) echo "hidden"; ?>>
				...
				<?php if ( isset($wppl_options['friends']['per_member_icon']) ) { ?>
					<div>
