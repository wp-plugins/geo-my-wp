...
jQuery(window).load(function(){ 
	...
	var membersMap = new google.maps.Map(document.getElementById('wppl-members-map'), {
		zoom: parseInt(fMapArgs.zoomLevel),
		panControl: Boolean(fMapArgs.mapControls.pan),
  		zoomControl: Boolean(fMapArgs.mapControls.zoom),
  		mapTypeControl: Boolean(fMapArgs.mapControls.map_type),
  		scaleControl: Boolean(fMapArgs.mapControls.scale),
  		streetViewControl: Boolean(fMapArgs.mapControls.street_view),
  		overviewMapControl: Boolean(fMapArgs.mapControls.overview),
