			...
			while (bp_profile_groups ()) : 
				...
				while (bp_profile_fields ()) : 
					...
					<?php if ( (bp_get_the_profile_field_type () != 'textbox') && (bp_get_the_profile_field_type () != 'datebox') ) {  ?>	
						...
						<input type="checkbox" name="<?php echo 'wppl_shortcode[' .$e_id .'][' .$variable . '][]'; ?>" value="<?php echo $field_id; ?>" <?php if ($option[$variable]) { echo (in_array($field_id, $option[$variable])) ? ' checked=checked' : '';} ?>/>
