...
function gmw_fl_xprofile_fields( $gmw, $class ) {
    ...
    foreach ( $total_fields as $field_id ) {
        ...
        switch ( $field_data->type ) {
            ...
            case 'selectbox':
            	echo '<div class="editfield field_' . $field_id . ' selectbox">';
            	echo '<select class="" name="'.$fieldName.'_'.$field_id.'">' . $field_data->name . '</span>';
            	$tt = array();
            	...
            	foreach ( $children as $child ) {
            		...
            		$selected     = ( in_array( $child->name, $tt ) ) ? "selected='selected'" : "";
            		echo '<option '.$selected.' value="' . $child->name . '" />' . $child->name . '</label>';
            ...
            case 'radio':
                ...
                echo '<div class="editfield field_' . $field_id . ' radio">';
                ...
                foreach ( $children as $child ) {
                    ...
                    echo '<label><input ' . $checked . ' type="radio" name="' . $fieldName . '_' . $field_id . '[]" value="' . $child->name . '" />' . $child->name . '</label>';
