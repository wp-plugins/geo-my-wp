...
function wppl_plugin_options_page() {
	...
	*/
	...
	echo				'<tr style=" height:40px;">';
	echo					'<td>';
	echo  						'<p><label for="element-page-id">Results Styling:</label></p>';
	echo					'</td>';
	echo					'<td>';
	echo    					'<p>
	...
	echo				'<tr style=" height:40px;">';
	echo					'<td>';
	echo  						'<p><label for="element-page-id">Feature Imgae Settings:</label></p>';
	echo					'</td>';
	echo					'<td>';
	echo    					'<p>Show Feature Image&nbsp;<input type="checkbox" name="show_thumb" value="1">';
	echo							'&nbsp;&nbsp;Height:&nbsp;<input type="text" name="thumb_height" value="" size="2">px';
	echo							'&nbsp;&nbsp;&nbsp;Width:&nbsp;<input type="text" name="thumb_width" value="" size="2">px';
	echo						'</p>';
	echo    				'</td>';
	echo				'</tr>';
	...
	echo				'<tr style=" height:40px;">';
	echo					'<td>';
	echo  						'<p><label for="element-page-id">Show excerpt:</label></p>';
	echo					'</td>';
	echo					'<td>';
	echo    					'<p><input type="checkbox" name="show_excerpt" value="1"></p>';
	echo    				'</td>';
	echo				'</tr>';
